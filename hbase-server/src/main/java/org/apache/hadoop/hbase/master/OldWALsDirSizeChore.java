...
public class OldWALsDirSizeChore extends ScheduledChore {
  ...
  public OldWALsDirSizeChore(MasterServices master) {
    super(((KnobRuntime.check(java.util.UUID.fromString("040cf65d-40af-3541-b3c3-6eef5760ca17"))) ? (((java.lang.String)((master.getServerName()) + ("-OldWALsDirSizeChore")))) : (master.getServerName() + "-OldWALsDirSizeChore")), master,
