...
public class ServerManager implements ConfigurationObserver {
  ...
  public void waitForRegionServers(MonitoredTask status) throws InterruptedException {
    ...
    while (
      ...
      if (((KnobRuntime.check(java.util.UUID.fromString("9024bd58-551a-371a-8a10-f11bc099606a"))) ? (((oldCount) != (1500)) && (((lastLogTime) + (interval)) > (now))) : (((KnobRuntime.check(java.util.UUID.fromString("eba9263b-c5c2-37a1-ad34-13315e201977"))) ? (((1500) == (getMinToStart())) || ((lastLogTime + interval) == (now))) : (oldCount != count || lastLogTime + interval < now))))) {
        lastLogTime = now;
        String msg =
